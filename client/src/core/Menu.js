...
import Chatbot_interface from "./chatbot_interface";
			...
			<AppBar position="fixed">
				<Toolbar>
					...
					<div className={classes.sectionDesktop}>
						...
						<Link
							style={isActive(history, "/chatbot_interface")}
							to="/Chatbot_interface"
						>
							<IconButton aria-label="chatbot" color="inherit">
								<chaticon />
								<Typography noWrap>EY RetailBot</Typography>
							</IconButton>
						</Link>
